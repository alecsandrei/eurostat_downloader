# Form implementation generated from reading ui file 'eurostat_downloader/ui/eurostat_downloader_dialog.ui'
#
...
class Ui_EurostatDownloaderDialog(object):
    def setupUi(self, EurostatDownloaderDialog):
        ...
        self.pushButtonInitializeTOC = QtWidgets.QPushButton(parent=EurostatDownloaderDialog)
        ...
        self.buttonReset = QtWidgets.QPushButton(parent=EurostatDownloaderDialog)
        self.buttonReset.setObjectName("buttonReset")
        self.verticalLayout_5.addWidget(self.buttonReset)
        self.buttonAdd = QtWidgets.QPushButton(parent=EurostatDownloaderDialog)
        self.buttonAdd.setObjectName("buttonAdd")
        self.verticalLayout_5.addWidget(self.buttonAdd)
        self.horizontalLayout_14 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_14.setObjectName("horizontalLayout_14")
        self.label_3 = QtWidgets.QLabel(parent=EurostatDownloaderDialog)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_14.addWidget(self.label_3)
        self.comboTableJoinField = QtWidgets.QComboBox(parent=EurostatDownloaderDialog)
        ...
        self.tabWidget = QtWidgets.QTabWidget(parent=EurostatDownloaderDialog)
        ...
        self.qgsComboLayer = QgsMapLayerComboBox(parent=self.tab_2)
        ...
        self.qgsComboLayerJoinField = QgsFieldComboBox(parent=self.tab_2)
        ...
        self.labelEnterPrefix = QtWidgets.QLabel(parent=self.tab_2)
        self.labelEnterPrefix.setObjectName("labelEnterPrefix")
        self.verticalLayout_2.addWidget(self.labelEnterPrefix)
        self.linePrefix = QtWidgets.QLineEdit(parent=self.tab_2)
        ...
        self.comboBoxColumnsToJoin = QtWidgets.QComboBox(parent=self.tab_2)
        ...
        self.buttonJoin = QtWidgets.QPushButton(parent=self.tab_2)
        ...
        self.pushButtonDatasetInformation = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.comboBoxGISCOTheme = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.comboBoxGISCOYear = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.comboBoxGISCOSpatialType = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.comboBoxGISCOScale = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.comboBoxGISCOProjection = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.pushButtonGISCOValidateJoin = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.pushButtonGISCOViewJoinReport = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.tableWidgetDownloadUnits = QtWidgets.QTableWidget(parent=self.tab)
        self.tableWidgetDownloadUnits.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        ...
        self.pushButtonGISCOJoin = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.lineSearch = QtWidgets.QLineEdit(parent=EurostatDownloaderDialog)
        self.lineSearch.setObjectName("lineSearch")
        self.verticalLayout.addWidget(self.lineSearch)
        self.treeDatabase = QtWidgets.QTreeWidget(parent=EurostatDownloaderDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeDatabase.sizePolicy().hasHeightForWidth())
        ...
        self.tableDataset = QtWidgets.QTableView(parent=EurostatDownloaderDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tableDataset.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.label_4 = QtWidgets.QLabel(parent=EurostatDownloaderDialog)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_4.addWidget(self.label_4)
        self.checkEnglish = QtWidgets.QCheckBox(parent=EurostatDownloaderDialog)
        ...
        self.label_6 = QtWidgets.QLabel(parent=EurostatDownloaderDialog)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_5.addWidget(self.label_6)
        self.checkGerman = QtWidgets.QCheckBox(parent=EurostatDownloaderDialog)
        ...
        self.label_5 = QtWidgets.QLabel(parent=EurostatDownloaderDialog)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_6.addWidget(self.label_5)
        self.checkFrench = QtWidgets.QCheckBox(parent=EurostatDownloaderDialog)
        ...
        self.toolButtonSettings = QtWidgets.QToolButton(parent=EurostatDownloaderDialog)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/plugins/eurostat_downloader/assets/settings.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.labelAgencyStatus = QtWidgets.QLabel(parent=EurostatDownloaderDialog)
        self.labelAgencyStatus.setObjectName("labelAgencyStatus")
        self.horizontalLayout_2.addWidget(self.labelAgencyStatus)
        self.button_box = QtWidgets.QDialogButtonBox(parent=EurostatDownloaderDialog)
    ...
    def retranslateUi(self, EurostatDownloaderDialog):
        ...
        self.treeDatabase.headerItem().setText(0, _translate("EurostatDownloaderDialog", "Dataset"))
        self.treeDatabase.headerItem().setText(1, _translate("EurostatDownloaderDialog", "Code"))
