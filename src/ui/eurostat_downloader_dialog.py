...
# Form implementation generated from reading ui file '/media/alex/alex/python-modules-packages-utils/QGIS_plugins/eurostat_downloader/ui/eurostat_downloader_dialog.ui'
#
...
class Ui_EurostatDownloaderDialog(object):
    def setupUi(self, EurostatDownloaderDialog):
        ...
        EurostatDownloaderDialog.resize(1118, 778)
        ...
        self.pushButtonValidateJoin = QtWidgets.QPushButton(self.tab)
        self.pushButtonValidateJoin.setObjectName("pushButtonValidateJoin")
        self.horizontalLayout_13.addWidget(self.pushButtonValidateJoin)
        self.labelValidateJoin = QtWidgets.QLabel(self.tab)
        self.labelValidateJoin.setText("")
        self.labelValidateJoin.setObjectName("labelValidateJoin")
        self.horizontalLayout_13.addWidget(self.labelValidateJoin)
        self.verticalLayout_8.addLayout(self.horizontalLayout_13)
        self.mGroupBoxCompletedDownloads = gui.QgsCollapsibleGroupBox(self.tab)
        self.mGroupBoxCompletedDownloads.setCollapsed(False)
        self.mGroupBoxCompletedDownloads.setObjectName("mGroupBoxCompletedDownloads")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.mGroupBoxCompletedDownloads)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scrollArea = QtWidgets.QScrollArea(self.mGroupBoxCompletedDownloads)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 312, 288))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.labelCompletedDownloads = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.labelCompletedDownloads.setText("")
        self.labelCompletedDownloads.setObjectName("labelCompletedDownloads")
        self.gridLayout_3.addWidget(self.labelCompletedDownloads, 0, 0, 1, 1)
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout_2.addWidget(self.scrollArea, 0, 0, 1, 1)
        self.verticalLayout_8.addWidget(self.mGroupBoxCompletedDownloads)
        self.pushButtonGISCOJoin = QtWidgets.QPushButton(self.tab)
        self.pushButtonGISCOJoin.setEnabled(False)
        self.pushButtonGISCOJoin.setObjectName("pushButtonGISCOJoin")
        self.verticalLayout_8.addWidget(self.pushButtonGISCOJoin)
        ...
        self.listDatabase.setMinimumSize(QtCore.QSize(0, 300))
    ...
    def retranslateUi(self, EurostatDownloaderDialog):
        ...
        self.pushButtonValidateJoin.setText(_translate("EurostatDownloaderDialog", "Validate join"))
